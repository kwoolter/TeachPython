...
def confirm(question: str):
    ...
    while True:
        ...
        choice = input("Choice?")
        if is_numeric(choice) and 0 < int(choice) <= (len(choices)):
            break
        else:
...
def type_text(text: str, wait=0.1):
    """Type out text with a delay between each character"""
